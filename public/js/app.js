...
window.VueAwesomeSwiper = __webpack_require__(8);
...
Vue.component('swiper-component', __webpack_require__(10));
Vue.component('big-swiper-component', __webpack_require__(13));
Vue.component('search-component', __webpack_require__(16));
Vue.component('test-component', __webpack_require__(19));
Vue.component('example-component', __webpack_require__(22));
Vue.component('movie-component', __webpack_require__(25));
Vue.component('video-component', __webpack_require__(28));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Promise.all([axios.get('/api/movies'), axios.get('/api/persons')]).then(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
                movies = _ref2[0],
                persons = _ref2[1];

            console.log(movies.data[0], persons.data[0]), _this.movies = movies.data[0], _this.persons = persons.data[0];
        ...
        _vm.loading
          ? _c("div", { staticClass: "card card-default" }, [
              _c("div", { staticClass: "card-header" }, [
                _vm._v(_vm._s(_vm.movies.title))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "card-body" }, [
                _vm._v(
                  _vm._s(
                    JSON.stringify(_vm.persons)
                      ? _vm.persons.Name + " " + _vm.persons.LastName
                      : ""
                  )
                )
              ])
...
Component.options.__file = "resources/assets/js/components/MovieComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-772789b8", Component.options)
  } else {
    hotAPI.reload("data-v-772789b8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        console.log(this.id);
        axios.get('/api/movies/' + this.id).then(function (response) {
            return _this.movie = response.data;
        }).catch(function (error) {
            _this.error = true;
        }).finally(function () {
    ...
    methods: {
        movieApiRequest: function movieApiRequest() {
            return axios.get('/api/movies');
        },
        moonwalkVideoRequest: function moonwalkVideoRequest() {
        ...
        _c("img", {
          ...
          attrs: {
            src:
              ...
              _vm.movie.image_name,
            alt: "Постер к фильму " + _vm.movie.title,
            title: "Постер к фильму " + _vm.movie.title
          }
        }),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-772789b8", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        console.log(this.token), console.log(this.kpId), axios.get('http://moonwalk.cc/api/videos.json', {
            params: {
                kinopoisk_id: 11025031,
                api_token: this.token
            }
        }).then(function (response) {
            return _this.video = response.data[0].iframe_url;
        }).catch(function (error) {
            _this.error = true;
        }).finally(function () {
            return _this.loading = false;
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col" }, [
        _c(
          "div",
          {
            staticClass: "bg-dark overflow-auto",
            staticStyle: { width: "610px", height: "370px" }
          },
          [
            _vm.error
              ? _c("div", { staticClass: "alert alert-danger m-1" }, [
                  _vm._v(
