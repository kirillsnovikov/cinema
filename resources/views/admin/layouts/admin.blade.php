			...
			<div class="row no-gutters">
				<div class="col-sm-2 bg-primary">
					<div class="list-group list-group-flush">
						<a href="{{ route('admin.article.index') }}" class="list-group-item d-flex justify-content-between align-items-center">Posts
						...
						<a href="{{ route('admin.category.index') }}" class="list-group-item d-flex justify-content-between align-items-center">Categories</a>
